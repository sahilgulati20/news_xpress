...
const NewsCard = ({ article }) => {
    return (
        <Link to={`/post/${article.slug}`} className="block">
            <article className="group cursor-pointer bg-white dark:bg-slate-900 rounded-lg p-3 hover:bg-gray-50 dark:hover:bg-slate-800 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl h-full">
